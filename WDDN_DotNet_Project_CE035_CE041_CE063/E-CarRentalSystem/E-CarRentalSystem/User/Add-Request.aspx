...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="display:inline-block; vertical-align:top">
        ...
        <asp:Button ID="request_button" runat="server" Text="Make Request" Font-Bold="False" BorderStyle="Solid" BackColor="Black" CssClass="btn" Font-Size="Large" ForeColor="White" Height="40px" Width="150px" OnClick="request_button_Click" />
        <br />
    </div>
